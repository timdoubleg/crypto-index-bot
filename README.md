...
1) Buy answering  ```yes``` to the output ```Do you want to proceed with rebalancing? ``` , you will disregard the smaller coins allocation and rebalance the portfolio based on the coins that are buyable. 
